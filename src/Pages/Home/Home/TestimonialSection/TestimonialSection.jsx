...
const TestimonialSection = () => {
    return (
        <div>
            <SectionTitle heading={"Testimonial Section"}></SectionTitle>
    ...
    <div
      ...
      <div className="flex flex-wrap items-center">
        <div className="block w-full shrink-0 grow-0 basis-auto lg:flex lg:w-6/12 xl:w-4/12">
          <img src="https://i.ibb.co/9tf1XBS/248672140-237903104922971-3040476626125467773-n.jpg" alt="Trendy Pants and Shoes"
        ...
        <div className="w-full shrink-0 grow-0 basis-auto lg:w-6/12 xl:w-8/12">
          <div className="px-6 py-12 md:px-12">
            ...
            <p className="mb-4 font-semibold">Full Stack Developwe</p>
